...
public abstract class BaseGrounder implements Grounder {
    ...
    case numericEffect:
      ...
      if (type != Type.assign) {
        TermType termType = type == Type.increase ? TermType.addition
            : type == Type.decrease ? TermType.subtraction : type == Type.scaleUp ? TermType.multiplication :
  ...
  public AbstractCondition simplifyRigidConditions(AbstractCondition condition, LiftedState liftedState,
    ...
    for (int i = 0; i < conditions.size(); i++) {
      ...
      } else if (c.getConditionType() == ConditionType.disjunction || c.getConditionType() == ConditionType.implication
          || c.getConditionType() == ConditionType.quantification || c.getConditionType() == ConditionType.negation) {
